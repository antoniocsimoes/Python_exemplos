...
def analisa_frequencia_de_letras(texto):
    ...
    # print("Aparições: ", aparicoes, "\n")

    total_ap = sum(aparicoes.values())

# for letra, frequencia in aparicoes.items():
#     tupla = (letra, frequencia / total_ap)
#     print(tupla)

    proporcoes = [(letra, frequencia / total_ap) for letra, frequencia in aparicoes.items()]
